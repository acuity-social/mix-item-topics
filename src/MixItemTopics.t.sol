...
contract MixItemTopicsTest is DSTest {
    ...
    function testGetTopicItems() public {
        ...
        bytes32[] memory itemIds = mixItemTopics.getTopicItems(topicHash, 0, 1);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 1, 0);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 1, 1);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 0);
        assertEq(itemIds.length, 0);
        ...
        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 100);
        ...
        itemIds = mixItemTopics.getTopicItems(topicHash, 1, 100);
        ...
        itemIds = mixItemTopics.getTopicItems(topicHash, 2, 100);
        assertEq(itemIds.length, 3);
        assertEq(itemIds[0], itemId2);
        assertEq(itemIds[1], itemId3);
        assertEq(itemIds[2], itemId4);
        itemIds = mixItemTopics.getTopicItems(topicHash, 3, 100);
        assertEq(itemIds.length, 2);
        assertEq(itemIds[0], itemId3);
        assertEq(itemIds[1], itemId4);
        itemIds = mixItemTopics.getTopicItems(topicHash, 4, 100);
        assertEq(itemIds.length, 1);
        assertEq(itemIds[0], itemId4);
        itemIds = mixItemTopics.getTopicItems(topicHash, 5, 100);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 6, 100);
        assertEq(itemIds.length, 0);

        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 0);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 1);
        assertEq(itemIds.length, 1);
        assertEq(itemIds[0], itemId0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 2);
        assertEq(itemIds.length, 2);
        assertEq(itemIds[0], itemId0);
        assertEq(itemIds[1], itemId1);
        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 3);
        assertEq(itemIds.length, 3);
        assertEq(itemIds[0], itemId0);
        assertEq(itemIds[1], itemId1);
        assertEq(itemIds[2], itemId2);
        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 4);
        assertEq(itemIds.length, 4);
        assertEq(itemIds[0], itemId0);
        assertEq(itemIds[1], itemId1);
        assertEq(itemIds[2], itemId2);
        assertEq(itemIds[3], itemId3);
        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 5);
        assertEq(itemIds.length, 5);
        assertEq(itemIds[0], itemId0);
        assertEq(itemIds[1], itemId1);
        assertEq(itemIds[2], itemId2);
        assertEq(itemIds[3], itemId3);
        assertEq(itemIds[4], itemId4);
        itemIds = mixItemTopics.getTopicItems(topicHash, 0, 6);
        assertEq(itemIds.length, 5);
        assertEq(itemIds[0], itemId0);
        assertEq(itemIds[1], itemId1);
        assertEq(itemIds[2], itemId2);
        ...
        assertEq(itemIds.length, 1);
        assertEq(itemIds[0], itemId1);
        itemIds = mixItemTopics.getTopicItems(topicHash, 1, 2);
        assertEq(itemIds.length, 2);
        assertEq(itemIds[0], itemId1);
        assertEq(itemIds[1], itemId2);
        itemIds = mixItemTopics.getTopicItems(topicHash, 1, 3);
        assertEq(itemIds.length, 3);
        assertEq(itemIds[0], itemId1);
        assertEq(itemIds[1], itemId2);
        assertEq(itemIds[2], itemId3);
        itemIds = mixItemTopics.getTopicItems(topicHash, 1, 4);
        assertEq(itemIds.length, 4);
        assertEq(itemIds[0], itemId1);
        assertEq(itemIds[1], itemId2);
        assertEq(itemIds[2], itemId3);
        assertEq(itemIds[3], itemId4);
        itemIds = mixItemTopics.getTopicItems(topicHash, 1, 5);
        assertEq(itemIds.length, 4);
        assertEq(itemIds[0], itemId1);
        assertEq(itemIds[1], itemId2);
        assertEq(itemIds[2], itemId3);
        ...
        itemIds = mixItemTopics.getTopicItems(topicHash, 2, 0);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 2, 1);
        assertEq(itemIds.length, 1);
        assertEq(itemIds[0], itemId2);
        itemIds = mixItemTopics.getTopicItems(topicHash, 2, 2);
        assertEq(itemIds.length, 2);
        assertEq(itemIds[0], itemId2);
        assertEq(itemIds[1], itemId3);
        itemIds = mixItemTopics.getTopicItems(topicHash, 2, 3);
        assertEq(itemIds.length, 3);
        assertEq(itemIds[0], itemId2);
        assertEq(itemIds[1], itemId3);
        assertEq(itemIds[2], itemId4);
        itemIds = mixItemTopics.getTopicItems(topicHash, 2, 4);
        assertEq(itemIds.length, 3);
        assertEq(itemIds[0], itemId2);
        assertEq(itemIds[1], itemId3);
        assertEq(itemIds[2], itemId4);

        itemIds = mixItemTopics.getTopicItems(topicHash, 3, 0);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 3, 1);
        assertEq(itemIds.length, 1);
        assertEq(itemIds[0], itemId3);
        itemIds = mixItemTopics.getTopicItems(topicHash, 3, 2);
        assertEq(itemIds.length, 2);
        assertEq(itemIds[0], itemId3);
        assertEq(itemIds[1], itemId4);
        itemIds = mixItemTopics.getTopicItems(topicHash, 3, 3);
        assertEq(itemIds.length, 2);
        assertEq(itemIds[0], itemId3);
        assertEq(itemIds[1], itemId4);

        itemIds = mixItemTopics.getTopicItems(topicHash, 4, 0);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 4, 1);
        assertEq(itemIds.length, 1);
        assertEq(itemIds[0], itemId4);
        itemIds = mixItemTopics.getTopicItems(topicHash, 4, 2);
        assertEq(itemIds.length, 1);
        assertEq(itemIds[0], itemId4);

        itemIds = mixItemTopics.getTopicItems(topicHash, 5, 0);
        assertEq(itemIds.length, 0);
        itemIds = mixItemTopics.getTopicItems(topicHash, 5, 1);
        assertEq(itemIds.length, 0);
    }
